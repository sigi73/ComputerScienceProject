...
TestApplication::TestApplication(int width, int height, std::vector<Mesh> built_meshes) {
  WIDTH = width;
  HEIGHT = height;
...
void TestApplication::initWindow() {
  ...
  glfwSetWindowSizeCallback(window, TestApplication::onWindowResized);
  ...
  void TestApplication::onWindowResized(GLFWwindow *window, int width, int height) {
    if (width == 0 || height == 0) return;

    TestApplication* app = reinterpret_cast<TestApplication*>
    (glfwGetWindowUserPointer(window));
    app->recreateSwapChain();
  }


  void TestApplication::cursor_pos_callback(GLFWwindow *window, double xpos, double ypos) {
  }

  void TestApplication::mouse_button_callback(GLFWwindow *window, int button, int action, int mods) {
    TestApplication *app = reinterpret_cast<TestApplication*>
    (glfwGetWindowUserPointer(window));
  ...
  void TestApplication::initVulkan() {
...
#ifdef ENUMERATE_EXTENSIONS
  void TestApplication::enumerateExtensions() {
  ...
  std::vector<const char*> TestApplication::getRequiredExtensions() {
  ...
  bool TestApplication::checkValidationLayerSupport() {
    uint32_t layerCount;
  ...
  void TestApplication::createInstance() {
  ...
  void TestApplication::createSurface() {
    if (glfwCreateWindowSurface(instance, window, nullptr, surface.replace()) != VK_SUCCESS) {
      throw std::runtime_error("Failed to create window surface\n");
    }
  }

  void TestApplication::setupDebugCallback() {
  ...
  void TestApplication::pickPhysicalDevice() {
  ...
  SwapChainSupportDetails TestApplication::querySwapChainSupport(VkPhysicalDevice device) {
  ...
  bool TestApplication::isDeviceSuitable(VkPhysicalDevice device) {
  ...
  QueueFamilyIndices TestApplication::findQueueFamilies(VkPhysicalDevice device) {
  ...
  bool TestApplication::checkDeviceExtensionSupport(VkPhysicalDevice device) {
  ...
  void TestApplication::createLogicalDevice() {
  ...
  void TestApplication::createSwapChain() {
  ...
  void TestApplication::createImageViews() {
  ...
  void TestApplication::createImageView(VkImage image, VkFormat format, VkImageAspectFlags
  ...
  void TestApplication::createDescriptorSetLayout() {
  ...
  void TestApplication::createGraphicsPipeline() {
  ...
  void TestApplication::createShaderModule(const std::vector<char> &code, VDeleter<VkShaderModule>
  &shaderModule) {
  ...
  void TestApplication::createFramebuffers() {
  ...
  void TestApplication::createCommandPool() {
  ...
  void TestApplication::createDepthResources() {
  ...
  VkFormat TestApplication::findDepthFormat() {
  ...
  VkFormat TestApplication::findSupportedFormat(const std::vector<VkFormat> &candidates, VkImageTiling
  ...
  bool TestApplication::hasStencilComponent(VkFormat format) {
    return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format ==
        VK_FORMAT_D24_UNORM_S8_UINT;
  }


  void TestApplication::createTextureImage() {
  ...
  void TestApplication::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling
  ...
  void TestApplication::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
  ...
  VkCommandBuffer TestApplication::beginSingleTimeCommands() {
  ...
  void TestApplication::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
  ...
  void TestApplication::createVertexBuffer() {
  ...
  void TestApplication::createIndexBuffer() {
  ...
  void TestApplication::createUniformBuffer() {
  ...
  void TestApplication::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
  ...
  void TestApplication::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
  ...
  void TestApplication::copyImage(VkImage srcImage, VkImage dstImage, uint32_t width,
                 uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
  ...
  uint32_t TestApplication::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
  ...
  void TestApplication::createDescriptorSet() {
  ...
  void TestApplication::createSemaphores() {
  ...
  void TestApplication::updateUniformBuffer() {
    /*
  ...
  void TestApplication::drawFrame() {
    uint32_t imageIndex;
  ...
  VkSurfaceFormatKHR TestApplication::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>
                                             availableFormats) {
  ...
  VkPresentModeKHR TestApplication::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>
  ...
  VkExtent2D TestApplication::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
  ...
  std::vector<char> TestApplication::readFile(const std::string &filename) {
