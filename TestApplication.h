...
#ifndef VULKANENGINE_TESTAPPLICATION_H
#define VULKANENGINE_TESTAPPLICATION_H
...
class TestApplication {
 public:
  TestApplication(int window_width, int window_height, std::vector<Mesh> built_meshes);
  void run();
